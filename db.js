...
/* { useNewUrlParser: true } as options to mongoose.connect() to handle deprecation warnings and ensure compatibility with the MongoDB Node.js driver. These options are recommended when connecting to MongoDB Atlas clusters. 
